...
<main class="blog category">
    <div class="site-width">
      ...
      <div class="cat_here">タグ：<?php echo get_the_category()[0]->name;?></div>
      <div class="tc">
        <div class="tc-1">
          <?php
          $args = array(
          ...
          if ( $the_query->have_posts() ) :
            ...
            <section>
              ...
              <div class="status">
                <span class="date">日付:<?php the_time('Y/m/d'); ?></span><span class="tag"><a href="<?php get_category_link( $cat ); ?>"><?php echo get_the_category()[0]->name;?></a></span>
              </div>
              <div class="fl">
                <div class="fl-1">
